...
export const STRUCTURES = {
  ...
  pole: ['M4.75 9V0h.5V9Z', 0.1, 'translate(5px, 2px)'],
  ...
  conical: [
    ...
    0.3,
    'translate(10px, 5px) rotate(20deg)',
  ],
  can: [
  ...
  pillar: [
    ...
    0.3,
    'translate(11.7px, 0.2px)rotate(20deg)',
  ],
  spar: [
  ...
  // other
  none: ['M6 9C6 10 4 10 4 9 4 8 6 8 6 9Z', 0.3, 'translate(5px, 9.5px)'],
} satisfies Record<
  string,
  [path: string, strokeWidth: number, transform: string]
>;
...
export function createStructure(
  ...
  const [path, strokeWidth] = STRUCTURES[structure];
  ...
  if (colourPattern) {
    ...
    return { svg, defs: { [patternId]: pattern } };
  }
